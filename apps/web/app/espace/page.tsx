...
export default function Workspace() {
  ...
  return <div className="workspace-shell">
    <aside className="workspace-nav"><p className="brand">EnCave <span>Assistant</span></p><nav aria-label="Navigation principale"><a href="/espace" aria-current="page">Paramètres</a></nav><p className="nav-caption">Votre équipe, réunie autour de votre cave.</p></aside>
