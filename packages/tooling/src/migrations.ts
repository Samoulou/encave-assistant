...
export const migrationFiles = ['001_identity.sql', '002_team_exports.sql', '003_case_core.sql', '004_workflow_commands.sql', '005_catalog.sql', '006_resources.sql', '007_manual_inquiries.sql'] as const;
