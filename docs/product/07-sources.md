...
**Contexte métier :** échanges de Samuel avec Julien fournis dans la conversation. Aucun entretien complémentaire ni accès aux outils de Gilliard. Ce contexte est consultatif : la décision de Sam du 7 septembre 2026 fixe la gouvernance produit indépendante des prospects et les connexions génériques par client.
...
## Compléments v1.1 — onboarding Microsoft générique

Sources Microsoft consultées le 7 septembre 2026. Elles documentent les possibilités et contraintes du fournisseur, pas la réussite de notre implémentation. Les contrats de connexion et les critères CON-01 à CON-12 sont des décisions de conception EnCave Assistant.

**[S21]** [Microsoft — applications Entra mono et multitenant](https://learn.microsoft.com/en-us/entra/identity-platform/single-and-multi-tenant-apps)

**[S22]** [Microsoft — Authorization Code et PKCE](https://learn.microsoft.com/en-us/entra/identity-platform/v2-oauth2-auth-code-flow)

**[S23]** [Microsoft — utilisation et validation des jetons d’accès](https://learn.microsoft.com/en-us/entra/identity-platform/access-tokens)
