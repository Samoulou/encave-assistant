...
Lire le [brief](00-BRIEF-DEVELOPPEMENT.md), le [périmètre](01-produit-et-perimetre.md), les [règles métier](02-cas-usage-et-regles.md), l’[architecture](04-architecture-donnees-api.md) et les [connecteurs et leur onboarding](10-connecteurs-et-onboarding.md). La [roadmap](06-roadmap-lancement-business.md) distingue livraison du logiciel, activation d’une connexion et mesure facultative de valeur terrain.

Le caviste conserve la validation des engagements de ses clients en A1. Sam gouverne la livraison du produit ; il ne valide pas toutes les réservations de toutes les caves et ne remplace pas le consentement d’un client à ses propres outils.
